...
config_de_cpu obtener_valores_de_configuracion_cpu(t_config* cpu_config){
    ...
    configuracion_cpu.PUERTO_MEMORIA = config_get_int_value(cpu_config, "PUERTO_MEMORIA");
    configuracion_cpu.PUERTO_ESCUCHA = config_get_int_value(cpu_config, "PUERTO_ESCUCHA");
