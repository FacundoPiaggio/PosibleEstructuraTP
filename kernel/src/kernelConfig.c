...
config_de_kernel obtener_valores_de_configuracion_kernel(t_config* kernelConfig){
    ...
    configuracion_kernel.PUERTO_MEMORIA = config_get_int_value(kernelConfig,"PUERTO_MEMORIA");
    configuracion_kernel.IP_FILESYSTEM = config_get_string_value(kernelConfig, "IP_FILESYSTEM");
    configuracion_kernel.PUERTO_FILESYSTEM = config_get_int_value(kernelConfig, "PUERTO_FILESYSTEM");
    configuracion_kernel.IP_CPU = config_get_string_value(kernelConfig,"IP_CPU");
    configuracion_kernel.PUERTO_CPU = config_get_int_value(kernelConfig,"PUERTO_CPU");
    configuracion_kernel.PUERTO_ESCUCHA = config_get_int_value(kernelConfig,"PUERTO_ESCUCHA");
